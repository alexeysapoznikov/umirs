    ...
    <main id="index">
        ...
        <div class="catalog-light-block">
            <div class="catalog-light-title">
                <h2>Тесты</h2>
                <a href="">Все тесты <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="catalog-light-list">
                <div class="catalog-item">
                    <div class="info-plash">
                        ...
                        <span id="type2">12 вопросов</span>
                    </div>
                    <img src="./assets/images/test.png" alt="">
                    <h3>Производса MV22 и при фокусировании</h3>
                    <p>Описание теста на знание чего то,для того чтобы пользователь понял что к чему</p>
